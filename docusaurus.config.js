...
const config = {
  ...
  tagline: 'Welcome to Code Is Science Community.',
  url: 'https://your-docusaurus-test-site.com',
  baseUrl: '/',
  onBrokenLinks: 'throw',
  onBrokenMarkdownLinks: 'warn',
  favicon: 'img/favicon.ico',
  organizationName: 'codeisscience', // Usually your GitHub org/user name.
  projectName: 'contributor-site', // Usually your repo name.
