...
#### `journalToCreate` ⟹ [Journal Input](../inputs-and-responses/journal#journalInput)

<a className='response' href='../inputs-and-responses/journal#journalResponse'>
  ⮩ Journal Response
</a>
...
#### `newJournalDetails` ⟹ [Journal Input](../inputs-and-responses/journal#journalInput)
